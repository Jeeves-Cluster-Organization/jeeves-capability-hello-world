...
*This contract is the authoritative source for capability integration. For implementation details, see [CAPABILITY_LAYER_INTEGRATION.md](CAPABILITY_LAYER_INTEGRATION.md).*
